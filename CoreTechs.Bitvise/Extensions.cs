...
namespace CoreTechs.Bitvise
{
    public static class Extensions
    {
        ...
        public static string Query([NotNull] this BssCfg641 server, [NotNull] string query, params object[] args)
        {
        ...
        /// </summary>
        public static void LockServerSettings([NotNull] this BssCfg641 server, TimeSpan? timeout)
        {
            if (server == null) throw new ArgumentNullException("server");
