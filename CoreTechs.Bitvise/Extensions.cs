...
namespace CoreTechs.Bitvise
{
    public static class Extensions
    {
        ...
        public static string Query([NotNull] this BssCfg631 server, [NotNull] string query, params object[] args)
        {
        ...
        public static void Command([NotNull] this BssCfg631 server, [NotNull] string command, params object[] args)
        {
            if (server == null) throw new ArgumentNullException("server");
        ...
        /// </summary>
        public static void LockServerSettings([NotNull] this BssCfg631 server, TimeSpan? timeout)
        {
            if (server == null) throw new ArgumentNullException("server");
